# Tianji-天机（四）Tianji MetaGPT Agent
...
## **6. 扩展指南：自定义Action和Role**

在了解了基本的使用方法后,让我们来看看如何扩展系统的功能。通过自定义Action和Role,我们可以根据实际需求构建更加个性化的智能体系统。详细代码可以参考 [test/agents/metagpt/test_metagpt_dummy.py](https://tianji.readthedocs.io/en/test/agents/metagpt/test_metagpt_dummy.py)
